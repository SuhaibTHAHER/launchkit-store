      ...
      {ownedWithDetails.length === 0 ? (
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
          {ownedWithDetails.map(({ row, product }) => {
            ...
            return (
              <div key={row.product_slug} className="border border-border bg-surface p-4">
                <ProductScreenshot
                  src={cover.src}
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <span className="label border border-positive/40 bg-positive/10 px-2 py-0.5 text-[10px] text-positive">
                    {t("owned")}
                  </span>
                </div>
